...
void rtype::Client::drawWaitingRoom()
{
    ...
    if (level_selected == 0)
        _graphical->drawSprite("letter_box", 1256, 440, 0, 0, 0.6, 0, 90, 4);
    else if (level_selected == 1)
        _graphical->drawSprite("letter_box", 1256, 540, 0, 0, 0.6, 0, 90, 4);
    else if (level_selected == 2)
        _graphical->drawSprite("letter_box", 1256, 640, 0, 0, 0.6, 0, 90, 4);

...
void rtype::Client::drawSettings()
{
    ...
    if (fps == 30)
        _graphical->drawSprite("fps_30_60", 1210, 390, 0.6, 0, 0, 0);
    else if (fps == 60)
        _graphical->drawSprite("fps_30_60", 1345, 390, 0.6, 0, 0, 0);
    else
        _graphical->drawSprite("fps_120", 1485, 390, 0.6, 0, 0, 0);
    ...
    _graphical->drawSprite("bar", 1175, 600, 0.45, 0, 0, 0);
    _graphical->drawSprite("button", 1183 + soundVolume * 4.05, 585, 0.2, 0, 0, 0);
